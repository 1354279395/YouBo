                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item active dropdown" id="Studentmanage">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" id="Student-menu">
                                ...
                                <a class="dropdown-item" id="student-add" href="studentlist?action=add">增加学生</a>
                                <a class="dropdown-item"id="student-mol" href="studentlist">删除修改</a>
                            </div>
                        </li>
                        <li class="nav-item active dropdown" id="teachermanage">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" id="teacher-menu">
                                ...
                                <a class="dropdown-item" id="teacher-add" href="teacherlist?action=add">增加老师</a>
                                <a class="dropdown-item"id="teacher-mol" href="teacherlist">删除修改</a>
                            </div>
                        </li>
                        <li class="nav-item active dropdown" id="classmanage">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" id="class-menu">
                                ...
                                <a class="dropdown-item" id="Clazz-add" href="classeslist?action=add">增加班级</a>
                                <a class="dropdown-item" id="Clazz-mol" href="classeslist">删除修改</a>
                            </div>
                        </li>
                        <li class="nav-item active dropdown" id="scoremanage">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" id="score-menu">
                                ...
                                <a class="dropdown-item" id="score-add" href="scorelist?action=add">增加学生成绩</a>
                                <a class="dropdown-item" id="score-mol" href="scorelist">删除修改成绩</a>
                            </div>
                        </li>
                    </ul>
                </div>
